...
export default function ShopListTile(props: Props) {
    ...
    return (
        <>
            <div className='flex flex-col shadow-2xl transform -skew-y-2 pl-4 my-4 rounded-xl px-5 bg-white md:flex-row py-4' style={{ borderTopWidth: 2, borderLeftWidth: 2, borderBottomWidth: 4, borderRightWidth: 7, borderColor: props.color, }}>
